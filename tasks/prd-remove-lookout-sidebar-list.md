...
- No changes to the Lookouts page.
...
3. `/lookouts` continues to show the user's Lookouts and reports.
...
- The Lookouts page still displays existing Lookouts and report history.
...
None. The main `Lookouts` navigation item remains the feature entry point.