...
| <a id="idea-formatted-lookout-emails"></a>Formatted Lookout emails | In progress | [PRD](../tasks/prd-formatted-lookout-emails.md) | Render Lookout reports as readable HTML email in light and dark email readers. |
