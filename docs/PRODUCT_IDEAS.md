...
| <a id="idea-mobile-layout-and-installable-app"></a>Mobile layout and installable web app | Draft | [PRD](../tasks/prd-mobile-layout-and-installable-app.md) | Improve narrow-screen use and add installable web-app support. |
...
| <a id="idea-scalable-research-history"></a>Scalable research history | In progress | [PRD](../tasks/prd-scalable-research-history.md) | Store, page, and retrieve research history at scale. |
...
| <a id="idea-thread-search"></a>Search and read previous threads | Done, Phase 1 | [PRD](../tasks/prd-thread-search.md) | Search past threads and read the relevant conversation context. Phase 2 keeps a separate release gate. |
