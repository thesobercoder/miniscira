...
| <a id="idea-self-hosted-youtube-transcripts"></a>Self-hosted YouTube transcripts | To do | [PRD](../tasks/prd-self-hosted-youtube-transcripts.md) | Read YouTube captions through a self-hosted Invidious service on Umbrel via a new agent tool. |
