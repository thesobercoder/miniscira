...
| <a id="idea-installable-app-and-offline-mode"></a>Installable app and offline mode | Draft | [PRD](../tasks/prd-installable-app-and-offline-mode.md) | Add browser installation, standalone launch, and a private-data-safe offline shell after the layout work. |
