...
// Animation timers here re-sync when speed/step/active props change, so they
// can't be mount-only. (The prefers-reduced-motion listener below is the one
// exception and could move to useMountEffect.)
// biome-ignore lint/style/noRestrictedImports: prop-synced animation timers
